...
export { sanitizeKey, sanitizeBucket }
 ...
 * @constructor
 */
export const ObjectStore = bucket => {
  AWS.config.update({
 ...
 */
export const makeSureBucketExists = async (client, bucketName) => {
 ...
 */
export const retrieve = async (bucketName, filepath) => {
  const objectStore = ObjectStore(bucketName)
  const params = {
    Bucket: sanitizeBucket(bucketName),
 ...
 */
export const retrieveToTmp = async (bucketName, filepath) => {
  bucketName = sanitizeBucket(bucketName)
...
export const deleteFolder = async (bucketName, folder) => {
  bucketName = sanitizeBucket(bucketName)
...
export const uploadDirectory = async (bucketName, localPath, bucketPath) => {
  bucketName = sanitizeBucket(bucketName)
  let uploads = []
...
export const downloadTarball = async (url, bucketName, path) => {
  bucketName = sanitizeBucket(bucketName)
